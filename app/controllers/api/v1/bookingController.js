    ...
    async addBooking(req,res, next){
        try{
            if(req.body.flight_type.toLowerCase() != "round trip"){
                ...
                if(req.body.user_id && req.body.schedule_id && req.body.origin_name && req.body.destination_name && req.body.plane_class && req.body.total_passenger && req.body.flight_type && req.body.price && req.body.flight_date && req.body.flight_back_date && req.body.departure_hour && req.body.arrival_hour && req.body.passenger_name && req.body.phone_number){
                    const origin_airport = await airportService.findAirport(req.body.origin_name)
                    const destination_airport = await airportService.findAirport(req.body.destination_name)
                    const data ={
                        user_id: req.body.user_id,
                        ...
                        flight_type : req.body.flight_type,
                        flight_date : req.body.flight_date,
                        flight_back_date : req.body.flight_back_date,
                        airline_name : "Tripie Airline",
                        departure_hour : req.body.departure_hour,
                        arrival_hour : req.body.arrival_hour,
                        price : req.body.price,
